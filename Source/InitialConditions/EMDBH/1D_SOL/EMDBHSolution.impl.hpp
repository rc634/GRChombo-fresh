...
//  */
//
// #if !defined(EMDBHSOLUTION_HPP_)
// #error "This file should only be included through EMDBHSolution.hpp"
// #endif
//
// #ifndef EMDBHSOLUTION_IMPL_HPP_
// #define EMDBHSOLUTION_IMPL_HPP_
//
// EMDBHSolution::EMDBHSolution() {}
//
// void EMDBHSolution::main()
// {
...
// // find_midint
// void EMDBHSolution::force_flat(const int iter_crit)
// {
...
// }
//
// double EMDBHSolution::find_WW_soliton()
// {
//     bool crossed;
//     double WW_ = 1.;
//     while (true)
...
// double EMDBHSolution::ww_min(const double WW_)
// {
...
// double EMDBHSolution::ww_max(const double WW_, const double lower_ww_)
// {
//     int accuracy = 400, eigenstate;
...
// double EMDBHSolution::ww_IB(double lower_ww_, double upper_ww_)
// {
...
// }
//
// double EMDBHSolution::ww_IB_soliton(double lower_ww_, double upper_ww_)
// {
//     int iter = 0, itermax, eigenstate, decimal_places_of_omega = 25.;
//     double middle_ww_;
//     bool crossed;
...
// }
//
// bool EMDBHSolution::soliton_eigen()
// {
...
// void EMDBHSolution::rk4(const double ww_)
// {
...
// void EMDBHSolution::rk4_asymp(const int iter, const bool adaptive,
//                                   const double ww_)
// {
...
//
// double EMDBHSolution::small_P_RHS(const double x, const double P,
...
// }
//
// double EMDBHSolution::P_RHS(const double x, const double P, const double DP,
...
// }
//
// double EMDBHSolution::DP_RHS(const double x, const double P,
//                                  const double DP, const double PSI,
//                                  const double DPSI, const double OM,
//                                  const double ww_)
// {
...
// }
//
// double EMDBHSolution::PSI_RHS(const double x, const double P,
//                                   const double DP, const double PSI,
//                                   const double DPSI, const double OM,
//                                   const double ww_)
// {
...
// }
//
// double EMDBHSolution::DPSI_RHS(const double x, const double P,
//                                    const double DP, const double PSI,
//                                    const double DPSI, const double OM,
//                                    const double ww_)
// {
...
// }
//
// double EMDBHSolution::OMEGA_RHS(const double x, const double P,
//                                     const double DP, const double PSI,
//                                     const double DPSI, const double OM,
//                                     const double ww_)
// {
...
// // star_type at top
// double EMDBHSolution::V(const double P)
// {
//     if (!solitonic)
//     {
...
//     }
// }
// double EMDBHSolution::DV(const double P)
// {
//     if (!solitonic)
//     {
...
// double EMDBHSolution::get_p_interp(const double r) const
// {
//     int iter = (int)floor(
...
// }
//
// double EMDBHSolution::get_dp_interp(const double r) const
// {
//     int iter = (int)floor(
//         r / dx); // index of 2nd (out of 4) gridpoints used for interpolation
//     double a =
...
// }
//
// double EMDBHSolution::get_lapse_interp(const double r) const
// {
//     int iter = (int)floor(
//         r / dx); // index of 2nd (out of 4) gridpoints used for interpolation
//     double a =
...
// }
//
// double EMDBHSolution::get_psi_interp(const double r) const
// {
//     int iter = (int)floor(
//         r / dx); // index of 2nd (out of 4) gridpoints used for interpolation
//     double a =
...
// }
//
// double EMDBHSolution::get_dpsi_interp(const double r) const
// {
//     int iter = (int)floor(
//         r / dx); // index of 2nd (out of 4) gridpoints used for interpolation
//     double a =
...
// }
//
// double EMDBHSolution::get_dlapse_interp(const double r) const
// {
//     int iter = (int)floor(
//         r / dx); // index of 2nd (out of 4) gridpoints used for interpolation
//     double a =
...
// // calc)
// double EMDBHSolution::get_mass() const { return aspect_mass; }
//
// // returns the eigenvalue
// double EMDBHSolution::get_w() const { return sqrt(ww); }
//
// double EMDBHSolution::get_r(const double frac) const
// {
...
// }
//
// void EMDBHSolution::set_initialcondition_params(
...
//     PC = m_params_EMDBH.central_amplitude_CSF;
//     EIGEN = m_params_EMDBH.eigen;
...
// }
//
// void EMDBHSolution::shout() const
// {
//     std::cout << "Haliboombah!" << std::endl;
// }
//
// #endif /* EMDBHSOLUTION_IMPL_HPP_ */
